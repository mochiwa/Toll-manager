...
DECLARE
	v_user appUser;
BEGIN
	SELECT employee_id,employee_login,employee_password INTO v_user FROM employee WHERE employee_id=v_id;
	RETURN v_user;
END $$ LANGUAGE plpgsql;
...
DECLARE
	v_user appUser;
BEGIN
	SELECT employee_id,employee_login,employee_password INTO v_user FROM employee WHERE employee_login=v_login;
	RETURN v_user;
END $$ LANGUAGE plpgsql;
